    ...
    <div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-4 mb-6 border dark:border-gray-700">
        <div className="flex flex-wrap gap-3 items-end">
          ...
          <button
            ...
            className="bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-200 px-4 py-2 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-500 font-medium"
          >
            Clear
          </button>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow overflow-hidden border dark:border-gray-700">
        {loading ? (
          ...
          <div className="text-center py-12 text-gray-500 dark:text-gray-400">No receipts found.</div>
        ) : (
